TOP_DIR			?=$(PWD)
QEMU			?=$(QBIN_DIR)/qemu-system-aarch64
QEMU_IMG		?=$(QBIN_DIR)/qemu-img
MACHINE			?=raspi3b
DRAM			?=1G
...
QFLAGS			+=-nographic -serial mon:stdio -no-reboot -device usb-kbd -device usb-mouse -device usb-net,netdev=net0 -netdev user,id=net0,hostfwd=tcp::2222-:22
